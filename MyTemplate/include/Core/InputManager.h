...
private:
    ...
    HINSTANCE m_hInstance = nullptr;        // 应用程序实例
...
public:
     ...
     * @return X坐标
     */
    int GetMouseX() const { return m_MousePosition.x; }
    
    /**
     * @brief 获取鼠标Y坐标
     * @return Y坐标
     */
    int GetMouseY() const { return m_MousePosition.y; }
    ...
    /**
     * @brief 检查是否按下了任意鼠标按键
     * @return 有鼠标按键按下返回TRUE，否则返回FALSE
     */
